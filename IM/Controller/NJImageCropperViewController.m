//
//  NJImageCropperViewController.m
//  HeadPortrait
//
...
@interface NJImageCropperViewController ()
...
@implementation NJImageCropperViewController
...
- (void)initView {
    ...
    self.showImgView.backgroundColor = [UIColor blackColor];
    ...
    self.overlayView.alpha = .8f;
    self.overlayView.backgroundColor = [UIColor blackColor];
    self.overlayView.userInteractionEnabled = NO;
    self.overlayView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    [self.view addSubview:self.overlayView];
    
   // CGFloat rationLength = CGRectGetWidth(self.cropFrame);
    self.ratioView = [[UIView alloc] initWithFrame:self.cropFrame];
    self.ratioView.layer.borderColor = [UIColor whiteColor].CGColor;
    self.ratioView.layer.borderWidth = 1.0f;
//    self.ratioView.layer.cornerRadius = rationLength/2;
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(NJImageCropperDelegate)]) {
