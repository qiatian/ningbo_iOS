...
//            [_photoImageView setImageWithURL:photo.photoURL placeholderImage:thumbImage options:SDWebImageRetryFailed progress:^(NSUInteger receivedSize, long long expectedSize) {
//                _photoImageView.progress = (double)receivedSize / expectedSize;
