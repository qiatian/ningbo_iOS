...
extern volatile bool g_continue_flag_s;
...
extern int g_max_connections_s;
extern int g_accept_threads_c;
extern int g_work_threads_s;
...
extern struct timeval g_network_tv_s;
...
extern int g_sync_log_buff_interval_s; //sync log buff to disk every interval seconds
...
extern bool g_store_slave_file_use_link_s; //if store slave file use symbol link
extern bool g_use_storage_id_s;  //identify storage by ID instead of IP address
extern byte g_id_type_in_filename_s; //id type of the storage server in the filename
extern bool g_use_access_log;  //if log to access log
extern bool g_rotate_access_log;  //if rotate the access log every day
extern bool g_rotate_error_log_s;  //if rotate the error log every day

extern TimeInfo g_access_log_rotate_time; //rotate access log time base
extern TimeInfo g_error_log_rotate_time_s;  //rotate error log time base
...
extern int g_allow_ip_count_s;  /* -1 means match any ip address */
extern in_addr_t *g_allow_ip_addrs_s;  /* sorted array, asc order */

extern gid_t g_run_by_gid;
extern uid_t g_run_by_uid;

extern char g_run_by_group_s[32];
extern char g_run_by_user_s[32];

extern char g_bind_addr[IP_ADDRESS_SIZE];
extern bool g_client_bind_addr;
extern bool g_storage_ip_changed_auto_adjust_s;
extern bool g_thread_kill_done;

extern bool g_file_sync_skip_invalid_record;

extern int g_thread_stack_size_s;
extern int g_upload_priority;
extern time_t g_up_time_s;
