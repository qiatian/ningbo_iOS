...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(LOCALIZATION(@"drag_refresh..."),),
                             NSLocalizedString(LOCALIZATION(@"drag_refresh..."),),
                             NSLocalizedString(LOCALIZATION(@"loading..."),),
                                nil];
