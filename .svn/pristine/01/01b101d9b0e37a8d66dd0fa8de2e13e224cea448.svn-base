...
extern FDFSStorageReservedSpace g_storage_reserved_space_s;  //fetch from tracker
...
extern TimeInfo g_trunk_create_file_time_base_s;
extern int g_trunk_create_file_interval_s;
extern int g_trunk_compress_binlog_min_interval_s;
extern ConnectionInfo g_trunk_server;  //the trunk server
extern bool g_if_use_trunk_file_s;   //if use trunk file
extern bool g_trunk_create_file_advance_s;
extern bool g_trunk_init_check_occupying_s;
extern bool g_trunk_init_reload_from_binlog_s;
extern bool g_if_trunker_self;   //if am i trunk server
extern int64_t g_trunk_create_file_space_threshold_s;
...
#define storage_check_reserved_space(pGroup) \
        fdfs_check_reserved_space(pGroup, &g_storage_reserved_space_s)

#define storage_check_reserved_space_trunk(pGroup) \
        fdfs_check_reserved_space_trunk(pGroup, &g_storage_reserved_space_s)

#define storage_check_reserved_space_path(total_mb, free_mb, avg_mb) \
        fdfs_check_reserved_space_path(total_mb, free_mb, avg_mb, \
                                &g_storage_reserved_space_s)

#define storage_get_storage_reserved_space_mb(total_mb) \
	fdfs_get_storage_reserved_space_mb(total_mb, &g_storage_reserved_space_s)
